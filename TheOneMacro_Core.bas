...
' Staff last name dimension. The higher number on the next line MUST be >= the number of staff members
    Dim BoothAlumDevStaff(1 To 75) As String
...
BoothAlumDevStaff(1) = "Axon, L"
BoothAlumDevStaff(2) = "Asaadi, H"
BoothAlumDevStaff(3) = "Bada, L"
BoothAlumDevStaff(4) = "Bergmann, P"
BoothAlumDevStaff(5) = "Buck, J"
BoothAlumDevStaff(6) = "Cantero, A"
BoothAlumDevStaff(7) = "Cernosia, P"
BoothAlumDevStaff(8) = "Chamberlin, S"
BoothAlumDevStaff(9) = "Coogan, K"
BoothAlumDevStaff(10) = "Cosgrove, T"
BoothAlumDevStaff(11) = "Clemente, M"
BoothAlumDevStaff(12) = "Darius, K"
BoothAlumDevStaff(13) = "Douponce, M"
BoothAlumDevStaff(14) = "Dove, C"
BoothAlumDevStaff(15) = "Eldringhoff, C"
BoothAlumDevStaff(16) = "Eunson, L"
BoothAlumDevStaff(17) = "Fuller, C"
BoothAlumDevStaff(18) = "Furlong, L"
BoothAlumDevStaff(19) = "Gonnella, L"
BoothAlumDevStaff(20) = "Green, A"
BoothAlumDevStaff(21) = "Griffith, L"
BoothAlumDevStaff(22) = "Gula, L"
BoothAlumDevStaff(23) = "Guynn, L"
BoothAlumDevStaff(24) = "Harmon, A"
BoothAlumDevStaff(25) = "Haley, R"
BoothAlumDevStaff(26) = "Hill, P"
BoothAlumDevStaff(27) = "Hively, P"
BoothAlumDevStaff(28) = "Hoffmann, C"
BoothAlumDevStaff(29) = "Hollendoner, E"
BoothAlumDevStaff(30) = "Humphrey, M"
BoothAlumDevStaff(31) = "Johnston, N"
BoothAlumDevStaff(32) = "Karr, C"
BoothAlumDevStaff(33) = "Knap, A"
BoothAlumDevStaff(34) = "Lalonde, A"
BoothAlumDevStaff(35) = "Lam, W"
BoothAlumDevStaff(36) = "Le, C"
BoothAlumDevStaff(37) = "Lee, K"
BoothAlumDevStaff(38) = "Li, D"
BoothAlumDevStaff(39) = "Macdougall, M"
BoothAlumDevStaff(40) = "Mckee, R"
BoothAlumDevStaff(41) = "Mckenzie, M"
BoothAlumDevStaff(42) = "Mihalek, J"
BoothAlumDevStaff(43) = "Miller, E"
BoothAlumDevStaff(44) = "Nash, R"
BoothAlumDevStaff(45) = "Nelson, A"
BoothAlumDevStaff(46) = "Niermann, A"
BoothAlumDevStaff(47) = "Nordmark, A"
BoothAlumDevStaff(48) = "Nolan, K"
BoothAlumDevStaff(49) = "Osborn, C"
BoothAlumDevStaff(50) = "Reid, C"
BoothAlumDevStaff(51) = "Rodriguez, J"
BoothAlumDevStaff(52) = "Saleh, M"
BoothAlumDevStaff(53) = "Scheid, V"
BoothAlumDevStaff(54) = "Schneider, K"
BoothAlumDevStaff(55) = "Seyal, T"
BoothAlumDevStaff(56) = "Smith, A"
BoothAlumDevStaff(57) = "Shea, E"
BoothAlumDevStaff(58) = "State, T"
BoothAlumDevStaff(59) = "Su, C"
BoothAlumDevStaff(60) = "Sullivan, K"
BoothAlumDevStaff(61) = "Tiemens, C"
BoothAlumDevStaff(62) = "Tkach, K"
BoothAlumDevStaff(63) = "Tobin, J"
BoothAlumDevStaff(64) = "Trent, A"
BoothAlumDevStaff(65) = "Ute, L"
BoothAlumDevStaff(66) = "Westhouse, E"
BoothAlumDevStaff(67) = "Young, K"
BoothAlumDevStaff(68) = "Huml, M"
